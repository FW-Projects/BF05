...
static void check_all_data(void);
void FlashProc(void)
{
#if 1
	...
	static uint8_t last_set_touch_set_temp_state;
    ...
    case FLASH_START:
        if (FALSE == first_start_flag)
        {
            ...
            last_set_time                         = sFWG2_t.Direct_handle_parameter.set_time;
            ...
            last_enhance_state                    = sFWG2_t.general_parameter.enhance_state;
			 last_set_touch_set_temp_state = sFWG2_t.general_parameter.touch_set_temp_state;
    ...
    case FLASH_GENERAL_DATA:
        if (flash_count % 2 != FALSE)
        {
			...
			flash_halfword_program(A_LAST_SET_TIME, sFWG2_t.Direct_handle_parameter.set_time);
			...
			flash_halfword_program(A_LAST_TOUCH_SET_TEMP_STATE, sFWG2_t.general_parameter.touch_set_temp_state);
            /* falsh ch data */
...
//            flash_halfword_program(B_LAST_SET_COUNTDOWN_TIME, sFWG2_t.general_parameter.countdown_time);
			flash_halfword_program(B_LAST_SET_TIME, sFWG2_t.Direct_handle_parameter.set_time);
			...
			flash_halfword_program(B_LAST_TOUCH_SET_TEMP_STATE, sFWG2_t.general_parameter.touch_set_temp_state);
...
static void get_data_from_a(void)
{
	...
	sFWG2_t.Direct_handle_parameter.set_time       = flash_wred_halfword(A_LAST_SET_TIME);
	...
	sFWG2_t.general_parameter.touch_set_temp_state = flash_wred_halfword(A_LAST_TOUCH_SET_TEMP_STATE);
    ...
    sFWG2_t.general_parameter.code2_pre_temp 	   = flash_wred_halfword(A_LAST_CODE2_PRE_TEMP);
    ...
    sFWG2_t.general_parameter.code3_pre_temp 	   = flash_wred_halfword(A_LAST_CODE3_PRE_TEMP);
...
static void get_data_from_b(void)
{
	...
	sFWG2_t.Direct_handle_parameter.set_time       = flash_wred_halfword(B_LAST_SET_TIME);
	...
	sFWG2_t.general_parameter.touch_set_temp_state = flash_wred_halfword(B_LAST_TOUCH_SET_TEMP_STATE);
    ...
    sFWG2_t.general_parameter.code2_pre_temp 	   = flash_wred_halfword(B_LAST_CODE2_PRE_TEMP);
    ...
    sFWG2_t.general_parameter.code3_pre_temp 	   = flash_wred_halfword(B_LAST_CODE3_PRE_TEMP);
...
static void check_all_data(void)
{
    ...
    if (sFWG2_t.general_parameter.fwg2_sleep_state != SLEEP_CLOSE
            && sFWG2_t.general_parameter.fwg2_sleep_state != SLEEP_OPEN)
    {
        sFWG2_t.general_parameter.fwg2_sleep_state = SLEEP_OPEN;
    }
	...
	if (sFWG2_t.general_parameter.enhance_state != ENHANCE_CLOSE && sFWG2_t.general_parameter.enhance_state != ENHANCE_OPEN)
    {
        sFWG2_t.general_parameter.enhance_state = ENHANCE_CLOSE;
    }
	
	if(sFWG2_t.general_parameter.touch_set_temp_state != TOUCH_CLICK && sFWG2_t.general_parameter.touch_set_temp_state != TOUCH_SLIDE)
	{
	sFWG2_t.general_parameter.touch_set_temp_state  = TOUCH_CLICK;
	}
...
//        sFWG2_t.general_parameter.countdown_time = 10;
//    }
	     if (sFWG2_t.Direct_handle_parameter.set_time > MAX_SET_TIME_VAL
             || sFWG2_t.Direct_handle_parameter.set_time < MIN_SET_TIME_VAL)
     {
         sFWG2_t.Direct_handle_parameter.set_time = 10;
     }
    ...
    {
        sFWG2_t.general_parameter.code0_temp_4 = 150;
    }

    if (sFWG2_t.general_parameter.code0_wind_4 > MAX_SET_WIND_VAL
            || sFWG2_t.general_parameter.code0_wind_4 < MIN_SET_WIND_VAL)
    {
        sFWG2_t.general_parameter.code0_wind_4 = 40;
    }

    if (sFWG2_t.general_parameter.code0_time_4 > MAX_SET_TIME_VAL
            || sFWG2_t.general_parameter.code0_time_4 < MIN_SET_TIME_VAL)
    {
        sFWG2_t.general_parameter.code0_time_4 = 3;
    }
    ...
    {
        sFWG2_t.general_parameter.code1_temp_4 = 450;
    }

    if (sFWG2_t.general_parameter.code1_wind_4 > MAX_SET_WIND_VAL
            || sFWG2_t.general_parameter.code1_wind_4 < MIN_SET_WIND_VAL)
    {
        sFWG2_t.general_parameter.code1_wind_4 = 40;
    }

    if (sFWG2_t.general_parameter.code1_time_4 > MAX_SET_TIME_VAL
            || sFWG2_t.general_parameter.code1_time_4 < MIN_SET_TIME_VAL)
    {
        sFWG2_t.general_parameter.code1_time_4 = 8;
    }
    ...
    {
        sFWG2_t.general_parameter.code2_temp_4 = 380;
    }

    if (sFWG2_t.general_parameter.code2_wind_4 > MAX_SET_WIND_VAL
            || sFWG2_t.general_parameter.code2_wind_4 < MIN_SET_WIND_VAL)
    {
        sFWG2_t.general_parameter.code2_wind_4 = 40;
    }

    if (sFWG2_t.general_parameter.code2_time_4 > MAX_SET_TIME_VAL
            || sFWG2_t.general_parameter.code2_time_4 < MIN_SET_TIME_VAL)
    {
        sFWG2_t.general_parameter.code2_time_4 = 4;
    }
    ...
    if (sFWG2_t.general_parameter.code3_time_4 > MAX_SET_TIME_VAL
            || sFWG2_t.general_parameter.code3_time_4 < MIN_SET_TIME_VAL)
    {
    ...
    if (sFWG2_t.general_parameter.code4_pre_time > MAX_SET_TIME_VAL
            || sFWG2_t.general_parameter.code4_pre_time < MIN_SET_TIME_VAL)
    {
        sFWG2_t.general_parameter.code4_pre_time = 60;
    }
    ...
    if (sFWG2_t.general_parameter.code4_time_1 > MAX_SET_TIME_VAL
            || sFWG2_t.general_parameter.code4_time_1 < MIN_SET_TIME_VAL)
    {
    ...
    if (sFWG2_t.general_parameter.code4_time_2 > MAX_SET_TIME_VAL
            || sFWG2_t.general_parameter.code4_time_2 < MIN_SET_TIME_VAL)
    {
    ...
    if (sFWG2_t.general_parameter.code4_time_3 > MAX_SET_TIME_VAL
            || sFWG2_t.general_parameter.code4_time_3 < MIN_SET_TIME_VAL)
    {
    ...
    if (sFWG2_t.general_parameter.code4_time_4 > MAX_SET_TIME_VAL
            || sFWG2_t.general_parameter.code4_time_4 < MIN_SET_TIME_VAL)
    {
