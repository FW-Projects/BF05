...
#define MES_SHOW_TIME 400

#define LOCK_RANGE 20
#define LOCK_RANGE_F 36
...
typedef enum
{
    ...
    CHANNEL1_LONG_PRESS = 0x46,
    LONG_PRESS_RELESS = 0x47,

    SAVE_CHANNEL_MES = 0x49, // 保存通道完成弹窗  0：隐藏  1：弹出

    TOUCH_CHANGE_TEMP = 0x4A,
    LONG_TOUCH_CHANGE_TEMP = 0x4B,
    TOUCH_CHANGE_WIND = 0x4C,
    LONG_TOUCH_CHANGE_WIND = 0x4D,

    CHANNEL2_PRESS = 0x4E,
    CHANNEL2_LONG_PRESS = 0x4F,
    CHANNEL3_PRESS = 0x50,
    CHANNEL3_LONG_PRESS = 0x51,
    CHANNEL4_PRESS = 0x52,
